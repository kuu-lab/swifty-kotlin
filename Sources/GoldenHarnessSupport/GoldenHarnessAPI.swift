...
private enum GoldenHarnessSemaComparisonNormalizer {
    // swiftlint:disable:next force_try
    private static let fileIDRegex = try! NSRegularExpression(pattern: "(^file f)(\\d+)", options: [.anchorsMatchLines])
    // swiftlint:disable:next force_try
    ...
    static func normalize(_ output: String) -> String {
        ...
        normalized = rewriteOrdinalMatches(in: normalized, regex: fileIDRegex)
