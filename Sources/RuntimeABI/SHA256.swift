/// Simple SHA-256 helper used by `RuntimeABISpec` to derive `specVersion`
/// from the canonical function specs. No external dependencies.
enum SHA256 {
    ...
    private static func sha256(_ bytes: [UInt8], _ output: inout [UInt8]) {
        let k: [UInt32] = [
