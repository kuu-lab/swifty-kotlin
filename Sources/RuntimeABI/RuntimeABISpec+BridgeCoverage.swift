...
public extension RuntimeABISpec {
    ...
    static let stringBridgeFunctions: [RuntimeABIFunctionSpec] = [
        ...
        bridgeSpec("kk_string_substringAfterLast_char",
            ...
            params: ["strRaw", "delimiterRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceAfter",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceAfter_char",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceAfterLast",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceAfterLast_char",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceBefore",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceBefore_char",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceBeforeLast",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
        bridgeSpec("kk_string_replaceBeforeLast_char",
            section: "String",
            params: ["strRaw", "delimiterRaw", "replacementRaw", "missingDelimiterValueRaw"],
            isThrowing: false),
    ]
