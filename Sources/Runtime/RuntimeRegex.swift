...
public func kk_regex_containsMatchIn(_ regexRaw: Int, _ strRaw: Int) -> Int {
    runtimeRegexContainsMatchIn(regexRaw, input: regexStringFromRaw(strRaw) ?? "")
}
