...
public enum RuntimeABISpec {
    ...
    public static let fileIOFunctions: [RuntimeABIFunctionSpec] = [
        ...
        RuntimeABIFunctionSpec(name: "kk_keypairgenerator_getInstance", parameters: [RuntimeABIParameter(name: "algorithmRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_keypairgenerator_initialize", parameters: [RuntimeABIParameter(name: "kpgRaw", type: .intptr), RuntimeABIParameter(name: "keySizeRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_keypairgenerator_generateKeyPair", parameters: [RuntimeABIParameter(name: "kpgRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_keypair_new", parameters: [RuntimeABIParameter(name: "publicKeyRaw", type: .intptr), RuntimeABIParameter(name: "privateKeyRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_keypair_publicKey", parameters: [RuntimeABIParameter(name: "keypairRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_keypair_privateKey", parameters: [RuntimeABIParameter(name: "keypairRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_getInstance", parameters: [RuntimeABIParameter(name: "algorithmRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_initSign", parameters: [RuntimeABIParameter(name: "sigRaw", type: .intptr), RuntimeABIParameter(name: "privateKeyRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_initVerify", parameters: [RuntimeABIParameter(name: "sigRaw", type: .intptr), RuntimeABIParameter(name: "publicKeyRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_update", parameters: [RuntimeABIParameter(name: "sigRaw", type: .intptr), RuntimeABIParameter(name: "dataRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_sign", parameters: [RuntimeABIParameter(name: "sigRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_signature_verify", parameters: [RuntimeABIParameter(name: "sigRaw", type: .intptr), RuntimeABIParameter(name: "signatureRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_certificatefactory_getInstance", parameters: [RuntimeABIParameter(name: "typeRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_certificatefactory_generateCertificate", parameters: [RuntimeABIParameter(name: "factoryRaw", type: .intptr), RuntimeABIParameter(name: "streamRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_x509certificate_getPublicKey", parameters: [RuntimeABIParameter(name: "certRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_x509certificate_getEncoded", parameters: [RuntimeABIParameter(name: "certRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_certpath_new", parameters: [RuntimeABIParameter(name: "certsRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_certpathvalidator_getInstance", parameters: [RuntimeABIParameter(name: "algorithmRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_certpathvalidator_validate", parameters: [RuntimeABIParameter(name: "validatorRaw", type: .intptr), RuntimeABIParameter(name: "certpathRaw", type: .intptr), RuntimeABIParameter(name: "paramsRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_trustanchor_new", parameters: [RuntimeABIParameter(name: "certRaw", type: .intptr), RuntimeABIParameter(name: "constraintsRaw", type: .intptr)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_pkixparameters_new", parameters: [RuntimeABIParameter(name: "trustAnchorsRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
        RuntimeABIFunctionSpec(name: "kk_pkixparameters_setTrustAnchors", parameters: [RuntimeABIParameter(name: "paramsRaw", type: .intptr), RuntimeABIParameter(name: "trustAnchorsRaw", type: .intptr), RuntimeABIParameter(name: "outThrown", type: .nullableIntptrPointer)], returnType: .intptr, section: "FileIO"),
