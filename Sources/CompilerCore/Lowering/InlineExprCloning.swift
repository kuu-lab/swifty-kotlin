...
/// `substituteType` closure that delegates to `InlineTypeSubstitution`, and
/// `expandLambdaBody` (which has no inline type parameters to substitute)
/// relies on the identity default.
