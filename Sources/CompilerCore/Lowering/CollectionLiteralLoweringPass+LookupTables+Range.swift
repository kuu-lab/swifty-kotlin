...
struct RangeLookupNames {
    ...
    init(interner: StringInterner) {
        ...
        kkOpRangeUntilName = interner.intern("__kk_op_rangeUntil")
        kkOpULongRangeUntilName = interner.intern("__kk_op_ulong_rangeUntil")
        kkOpDownToName = interner.intern("__kk_op_downTo")
        kkOpStepName = interner.intern("__kk_op_step")
