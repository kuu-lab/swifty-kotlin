...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_string_replace_char_ignoreCase"),
            ...
            interner.intern("kk_channel_send_suspending"),
            interner.intern("kk_channel_iterator"),
            interner.intern("kk_channel_iterator_hasNext"),
            interner.intern("kk_channel_iterator_next"),
            interner.intern("kk_channel_pipeline_drain"),
            interner.intern("kk_broadcast_channel_create"),
            interner.intern("kk_broadcast_channel_subscribe"),
            interner.intern("kk_broadcast_channel_unsubscribe"),
            interner.intern("kk_broadcast_channel_send"),
            interner.intern("kk_broadcast_channel_close"),
