...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_atomic_int_array_createFromArray"),
            ...
            interner.intern("kk_atomic_int_array_exchange"),
            interner.intern("kk_atomic_int_array_compareAndSet"),
            interner.intern("kk_atomic_int_array_compareAndExchange"),
            interner.intern("kk_atomic_int_array_getAndAdd"),
            interner.intern("kk_atomic_int_array_addAndGet"),
            interner.intern("kk_atomic_int_array_getAndIncrement"),
            interner.intern("kk_atomic_int_array_incrementAndGet"),
            interner.intern("kk_atomic_int_array_getAndDecrement"),
            interner.intern("kk_atomic_int_array_decrementAndGet"),
            interner.intern("kk_atomic_int_array_getAndUpdate"),
            interner.intern("kk_atomic_int_array_updateAndGet"),
            interner.intern("kk_atomic_long_array_create"),
            interner.intern("kk_atomic_long_array_createFromArray"),
            ...
            interner.intern("kk_atomic_long_array_exchange"),
            interner.intern("kk_atomic_long_array_compareAndSet"),
            interner.intern("kk_atomic_long_array_compareAndExchange"),
            interner.intern("kk_atomic_long_array_getAndAdd"),
            interner.intern("kk_atomic_long_array_addAndGet"),
            interner.intern("kk_atomic_long_array_getAndIncrement"),
            interner.intern("kk_atomic_long_array_incrementAndGet"),
            interner.intern("kk_atomic_long_array_getAndDecrement"),
            interner.intern("kk_atomic_long_array_decrementAndGet"),
            interner.intern("kk_atomic_long_array_getAndUpdate"),
            interner.intern("kk_atomic_long_array_updateAndGet"),
