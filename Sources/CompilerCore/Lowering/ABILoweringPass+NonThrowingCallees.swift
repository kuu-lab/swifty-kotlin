...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_atomic_int_load_order"),
            interner.intern("kk_atomic_int_store"),
            interner.intern("kk_atomic_int_store_order"),
            interner.intern("kk_atomic_int_exchange"),
            interner.intern("kk_atomic_int_exchange_order"),
            interner.intern("kk_atomic_int_compareAndSet"),
            interner.intern("kk_atomic_int_compareAndSet_order"),
            ...
            interner.intern("kk_atomic_long_load_order"),
            interner.intern("kk_atomic_long_store"),
            interner.intern("kk_atomic_long_store_order"),
            interner.intern("kk_atomic_long_exchange"),
            interner.intern("kk_atomic_long_exchange_order"),
            interner.intern("kk_atomic_long_compareAndSet"),
            interner.intern("kk_atomic_long_compareAndSet_order"),
            ...
            interner.intern("kk_atomic_ref_load_order"),
            interner.intern("kk_atomic_ref_store"),
            interner.intern("kk_atomic_ref_store_order"),
            interner.intern("kk_atomic_ref_exchange"),
            interner.intern("kk_atomic_ref_exchange_order"),
            interner.intern("kk_atomic_ref_compareAndSet"),
            interner.intern("kk_atomic_ref_compareAndSet_order"),
            ...
            interner.intern("kk_atomic_bool_load_order"),
            interner.intern("kk_atomic_bool_store"),
            interner.intern("kk_atomic_bool_store_order"),
            interner.intern("kk_atomic_bool_exchange"),
            interner.intern("kk_atomic_bool_exchange_order"),
            interner.intern("kk_atomic_bool_compareAndSet"),
            interner.intern("kk_atomic_bool_compareAndSet_order"),
