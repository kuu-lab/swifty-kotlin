...
"""
    ...
    // MIGRATION-COL-005: List search HOF (first, firstOrNull, last, lastOrNull,
    // single, singleOrNull, find, findLast, indexOf, indexOfFirst, indexOfLast)
    static let kotlinCollectionsSearchSource = """
package kotlin.collections
