...
/// Synthetic Kotlin/JS `eval` external function surface.
extension DataFlowSemaPhase {
    func registerSyntheticJsEvalStubs(
        symbols: SymbolTable,
        types: TypeSystem,
        ...
        registerSyntheticJsEvalFunction(
    ...
    private func registerSyntheticJsEvalFunction(
        ...
        let functionName = interner.intern("eval")
        ...
        let parameterName = interner.intern("expr")
