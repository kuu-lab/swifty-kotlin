...
/// Residual synthetic stdlib stub registration for buildList (STDLIB-070).
/// buildSet and buildMap are now source-backed in
/// Sources/CompilerCore/Stdlib/kotlin/collections/CollectionBuilders.kt (KSP-623).
/// buildList retains the capacity overload external link as a bridge while source-backed.
/// Lowering rewrites source buildList calls to __kk_build_* runtime calls.
