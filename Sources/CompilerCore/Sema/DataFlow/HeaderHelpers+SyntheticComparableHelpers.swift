...
extension DataFlowSemaPhase {
    ...
    func setupPrimitiveComparableImplementations(
        ...
        for typeName in primitiveTypeNames {
            ...
            // KSP-833/KSP-853/KSP-904/KSP-910/KSP-913: Double, Int, UByte,
            // ULong, and UShort are compiler primitives, so retain only the
            // synthetic Companion anchors needed by source-backed extensions.
            if typeName == "Double" || typeName == "Int" || typeName == "UByte" || typeName == "ULong" || typeName == "UShort" {
