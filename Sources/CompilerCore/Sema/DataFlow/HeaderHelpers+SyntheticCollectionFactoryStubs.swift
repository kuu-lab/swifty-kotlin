...
///
/// The JVM-flavoured collection names (`ArrayList` / `HashSet` / `HashMap` /
/// `LinkedHashMap` aliases and the `LinkedHashSet` class) moved to bundled
/// Kotlin source in `Stdlib/kotlin/collections/TypeAliases.kt` (KSP-627).
///
