...
///
/// The collection type aliases (`ArrayList` / `HashMap` / `LinkedHashMap`) and
/// the concrete `HashSet` / `LinkedHashSet` classes that used to be registered
/// here are declared by `Stdlib/kotlin/collections/CollectionAliases.kt`.
///
...
extension DataFlowSemaPhase {
    ...
    func registerSyntheticCollectionFactoryStubs(
        ...
        register(name: "hashSetOf", typeParameterNames: ["T"], isVararg: true, externalLinkName: "__kk_hash_set_of")
