...
/// Synthetic Kotlin/JS `nativeSetter` annotation surface.
extension DataFlowSemaPhase {
    func registerSyntheticNativeSetterStubs(
        ...
        appendNativeSetterAnnotationMetadata(to: annotationSymbol, symbols: symbols)
    }

    private func appendNativeSetterAnnotationMetadata(
        to symbol: SymbolID,
        symbols: SymbolTable
    ) {
        let records = [
