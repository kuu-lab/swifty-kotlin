...
extension CallTypeChecker {
    func inferRegularMemberCall(
        ...
        let sourceBackedTrailingLambdaMemberNames: Set<String> = ["map", "filter", "filterNot", "mapIndexed", "mapNotNull", "filterIndexed", "onEach", "onEachIndexed", "ifEmpty", "flatMap", "flatMapIndexed", "toMap", "toSet", "toHashSet", "toMutableList", "toMutableSet", "joinTo", "joinToString", "isNotEmpty"]
