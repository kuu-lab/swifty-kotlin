...
// type-check inside extension function bodies in this compiler (BUG-166).
 ...
 *
 * BUG-167 workaround: the 1-arg CharSequence.lastIndexOf(Char) fast path crashes
...
/** @see substringAfterLast — BUG-167 workaround, see substringBeforeLast(Char) above. */
...
/** @see replaceAfterLast — BUG-167 workaround, see substringBeforeLast(Char) above. */
...
/** @see replaceBeforeLast — BUG-167 workaround, see substringBeforeLast(Char) above. */
