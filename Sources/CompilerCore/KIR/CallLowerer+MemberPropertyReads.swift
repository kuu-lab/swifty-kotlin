...
extension CallLowerer {
    /// BUG-223: whether a class member-property read/write should dispatch
    ...
    /// never the runtime type's override (BUG-224 tracks that `super.p`
    ...
    func tryLowerStoredMemberPropertyRead(
        ...
        // BUG-223: a stored open/abstract/override property whose owner has
