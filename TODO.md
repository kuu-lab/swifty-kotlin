...
#### JS Array関連stub
- [x] CLEANUP-STUB-001: `kk_js_array_toArray` stub削除
- [x] CLEANUP-STUB-002: `kk_js_array_get` stub削除
...
- [x] CLEANUP-STUB-008: `kk_js_map_toMutableMap` stub削除
#### JS Set関連stub
- [x] CLEANUP-STUB-009: `kk_js_set_toSet` stub削除
...
- [x] CLEANUP-STUB-018: Wasm Unsafe Annotation stub削除（`HeaderHelpers+SyntheticWasmUnsafeAnnotationStubs.swift`）
...
- [x] CLEANUP-STUB-027: `kk_java_atomic_ref_asKotlinAtomic` stub削除（`HeaderHelpers+SyntheticAtomicStubs.swift`, `RuntimeAtomic.swift`実装も削除）
...
- [x] CLEANUP-STUB-029: `kk_java_atomic_long_array_asKotlinAtomicArray` stub削除（`HeaderHelpers+SyntheticAtomicStubs.swift`, `RuntimeAtomic.swift`実装も削除）
...
- [x] CLEANUP-STUB-061: JS IntNumberInterop stub削除（`HeaderHelpers+SyntheticJsIntNumberInteropStubs.swift`）
- [x] CLEANUP-STUB-062: JS ArrayInterop stub削除（`HeaderHelpers+SyntheticJsArrayInteropStubs.swift`）
...
- [x] CLEANUP-STUB-070: JS Dynamic stub削除（`HeaderHelpers+SyntheticJsDynamicStubs.swift`）
...
> 既に 50 ファイルへ +分割済み。本体 `RuntimeABISpec.swift` はコア型定義 + `allFunctions` + `generateCHeader()` のみ（約 163 行）。
