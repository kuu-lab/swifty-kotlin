...
- [ ] BUG-038: 初期化子付き top-level `var` の custom getter 読み出しが getter を経由せず property global を直接読む（最小再現: `Scripts/diff_cases/top_level_backing_field.kt`、発見元: PR #4684 の CI）。修正: PR #4684
