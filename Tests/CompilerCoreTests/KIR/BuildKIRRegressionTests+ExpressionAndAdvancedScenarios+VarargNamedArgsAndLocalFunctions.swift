...
extension BuildKIRRegressionTests {
    ...
    private func sharedVarargCtx() throws -> CompilationContext {
        ...
        let sources: [String] = [
            ...
            fun main6() = report(label = "test", 10, 20, 30)
            """,
            """
            package sample7
            ...
            fun main8() = flag(true, false, true)
            """,
            """
            package sample9
            fun nums(vararg ds: Double): Int = 0
            fun main9() = nums(1.5, 2.5, 3.5)
            """,
            """
            package sample10
            fun nums(vararg ls: Long): Int = 0
            fun main10() = nums(1L, 2L, 3L)
            """,
            """
            package sample11
