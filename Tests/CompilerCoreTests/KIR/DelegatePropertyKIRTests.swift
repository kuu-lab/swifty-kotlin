...
struct DelegatePropertyKIRTests {
    ...
    @Test func testLazyDelegateEmitsCreateAndGetValueInKIR() throws {
        let source = """
        val x by lazy { 42 }
        fun main() = println(x)
        """
    ...
    @Test func testLazyDelegateGetValueCallIsNonThrowing() throws {
        let source = """
        val x by lazy { 42 }
        fun main() = println(x)
        """
    ...
    @Test func testObservableDelegateEmitsCreateAndGetValueInKIR() throws {
        let source = """
    ...
    @Test func testVetoableDelegateEmitsCreateAndGetValueInKIR() throws {
        let source = """
        import kotlin.properties.Delegates
    ...
    @Test func testCustomDelegateEmitsCreateAndGetValueInKIR() throws {
        let source = """
    ...
    @Test func testCustomDelegateGetValueCallIsNonThrowing() throws {
        let source = """
        val x by myCustomDelegate()
        fun main() = println(x)
        """
    ...
    @Test func testStdlibDelegateLoweringRewritesLazyAccessToGetValue() throws {
        let source = """
        val x by lazy { 42 }
        fun main() = println(x)
        """
    ...
    @Test func testStdlibDelegateLoweringRewritesCustomAccessToGetValue() throws {
        let source = """
    ...
    @Test func testSemaDelegatePropertyWithLazyCompilesWithoutErrors() throws {
        let source = """
    ...
    @Test func testSemaDelegatePropertyWithObservableCompilesWithoutErrors() throws {
        let source = """
        import kotlin.properties.Delegates
        var name: String by Delegates.observable("initial") { prop, old, new ->
            println("changed")
    ...
    @Test func testSemaDelegatePropertyWithVetoableCompilesWithoutErrors() throws {
        let source = """
        import kotlin.properties.Delegates
        var count: Int by Delegates.vetoable(0) { prop, old, new ->
            new >= 0
    ...
    @Test func testDetectDelegateKindLazyProducesLazyCreate() throws {
        let source = """
        val x by lazy { 42 }
        fun main() = println(x)
        """
    ...
    @Test func testDetectDelegateKindUnknownProducesCustomCreate() throws {
        let source = """
    ...
    @Test func testDetectDelegateKindNotNullProducesNotNullCreate() throws {
        let source = """
        import kotlin.properties.Delegates
    ...
    @Test func testLazyDelegateEndToEndCompilesToExecutable() throws {
        let source = """
        val x by lazy { 42 }
        fun main() {
            println(x)
    ...
    @Test func testNotNullDelegateReadBeforeAssignmentTrapsWithHelpfulMessage() throws {
        let source = """
        import kotlin.properties.Delegates
    ...
    @Test func testMultipleLazyDelegatePropertiesCompileAndLower() throws {
        let source = """
        val a by lazy { 1 }
        val b by lazy { 2 }
    ...
    @Test func testDelegatePropertyWithExplicitTypeAnnotation() throws {
        let source = """
        val x: Int by lazy { 42 }
        fun main() = println(x)
        """
