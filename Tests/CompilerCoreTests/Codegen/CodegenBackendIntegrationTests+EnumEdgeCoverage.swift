...
extension CodegenBackendIntegrationTests {
    func testCodegenCompilesEnumEntriesTopLevelDefaultImport() throws {
        let source = """
        ...
        try withTemporaryFile(contents: source) { path in
            ...
            let ctx = try runCodegenPipeline(
                inputPath: path,
                moduleName: "EnumEntriesTopLevelDefaultImport",
                emit: .executable,
            ...
            XCTAssertEqual(normalizedStdout, "[0, 1]\n")
        }
    }
