...
struct KotlinVersionSyntheticStubTests {
    ...
    @Test
    func testKotlinVersionSyntheticStubTestsInventory() throws {
        let sources: [String] = [
            """
            package sample0
        ...
        try withTemporaryFiles(contents: sources) { paths in
            ...
            // === testKotlinVersionConstructorsAndPropertiesAreRegistered ===
            do {
            ...
            // Source compiled for testKotlinVersionConstructorsAndPropertiesResolveInSource
