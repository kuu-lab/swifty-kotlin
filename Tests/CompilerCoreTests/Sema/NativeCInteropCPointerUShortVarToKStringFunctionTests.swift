...
struct NativeCInteropCPointerUShortVarToKStringFunctionTests {
    ...
    func testRunSemaClean() throws {
        ...
        let sources: [String] = [
            // testCPointerUShortVarToKStringFunctionSurfaceMatchesNativeShape
            """
            package sample0
            fun noop() {}
            """,
            // testCPointerUShortVarToKStringFunctionLinksToRuntimeSymbol
            """
            package sample1
            fun noop() {}
            """,
            // testCPointerUShortVarToKStringFunctionResolvesInSource
            """
            package sample2
        ...
        try withTemporaryFiles(contents: sources) { paths in
            ...
            do {
                ...
                #expect(!(sample2Diagnostics.contains { $0.severity == .error }), "resolve: \(sample2Diagnostics)")
