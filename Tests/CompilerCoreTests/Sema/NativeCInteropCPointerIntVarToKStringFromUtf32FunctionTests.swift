...
struct NativeCInteropCPointerIntVarToKStringFromUtf32FunctionTests {
    ...
    func testRunSemaClean() throws {
        ...
        let sources: [String] = [
            // testCPointerIntVarToKStringFromUtf32FunctionSurfaceMatchesNativeShape
            """
            package sample0
            fun noop() {}
            """,
            // testCPointerIntVarToKStringFromUtf32FunctionLinksToRuntimeSymbol
            """
            package sample1
            fun noop() {}
            """,
            // testCPointerIntVarToKStringFromUtf32FunctionResolvesInSource
            """
            package sample2
