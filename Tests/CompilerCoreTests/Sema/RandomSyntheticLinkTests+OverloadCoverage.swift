...
extension RandomSyntheticLinkTests {
    ...
    @Test
    func testRandomSyntheticLinkTestsSurfaceInventory() throws {
        let source = """
        fun noop() {}
        """
        try withTemporaryFile(contents: source) { path in
            ...
            // === testRandomIntSeedConstructorIsRegistered ===
            do {
            ...
            // === testRandomLongSeedConstructorIsRegistered ===
            do {
            ...
            // === testRandomDefaultSingletonIsRegistered ===
            do {
            ...
            // === testNextULongOverloadsAreRegistered ===
            do {
            ...
            // === testNextUIntOverloadsAreRegistered ===
            do {
            ...
            // === testNextBytesSizeOverloadIsRegistered ===
            do {
            ...
            // === testNextUBytesOverloadsAreRegistered ===
            do {
            ...
            // === testNextBitsMemberIsRegistered ===
            do {
            ...
            // === testNextBytesArrayRangeOverloadIsRegistered ===
            do {
