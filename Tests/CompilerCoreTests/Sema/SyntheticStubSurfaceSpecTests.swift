...
struct SyntheticStubSurfaceSpecTests {
    ...
    @Test
    func testSyntheticStubSurfaceSpecTestsSurfaceInventory() throws {
        let source = """
        fun noop() {}
        """
        try withTemporaryFile(contents: source) { path in
            ...
            // === testDeclarativeThrowableMemberSpecsRegisterLinksAndTypes ===
            do {
            ...
            // === testDeclarativeCharSpecsKeepRadixOverloadParameterMetadata ===
            do {
