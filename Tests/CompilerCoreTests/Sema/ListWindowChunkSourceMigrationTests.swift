...
struct ListWindowChunkSourceMigrationTests {
    @Test
    func testListWindowChunkSourceMigration() throws {
        let source = """
        package sample0
        fun noop() {}
        """
        ...
        // migratedListWindowChunkFunctionsAreBundledSourceDefinitions
        do {
        ...
        // migratedListWindowChunkFunctionsDoNotKeepPublicRuntimeLinkedMembers
        do {
