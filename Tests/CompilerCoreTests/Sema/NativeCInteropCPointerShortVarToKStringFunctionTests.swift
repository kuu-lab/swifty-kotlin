...
struct NativeCInteropCPointerShortVarToKStringFunctionTests {
    ...
    func testRunSemaClean() throws {
        ...
        let sources: [String] = [
            // testCPointerShortVarToKStringFunctionSurfaceMatchesNativeShape
            """
            package sample0
            fun noop() {}
            """,
            // testCPointerShortVarToKStringFunctionLinksToRuntimeSymbol
            """
            package sample1
            fun noop() {}
            """,
            // testCPointerShortVarToKStringFunctionResolvesInSource
            """
            package sample2
