...
@Suite
struct SequenceAssociateWithToSyntheticTests {
    @Test func testSequenceAssociateWithToResolvesInCallExpressions() throws {
        let source = """
        ...
        try withTemporaryFile(contents: source) { path in
            ...
            #expect(
                ...
                Comment(rawValue: "Expected Sequence.associateWithTo surface to resolve cleanly, got: \(diagnosticSummary)")
            )
