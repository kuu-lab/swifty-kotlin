...
@Suite
struct NativeCInteropCPointerShortVarToKStringFromUtf16FunctionTests {
    @Test func testCPointerShortVarToKStringFromUtf16FunctionSurfaceMatchesNativeShape() throws {
    ...
    @Test func testCPointerShortVarToKStringFromUtf16FunctionResolvesInSource() throws {
