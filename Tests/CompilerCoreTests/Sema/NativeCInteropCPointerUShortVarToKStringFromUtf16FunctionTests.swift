...
struct NativeCInteropCPointerUShortVarToKStringFromUtf16FunctionTests {
    ...
    func testRunSemaClean() throws {
        ...
        let sources: [String] = [
            // testCPointerUShortVarToKStringFromUtf16FunctionSurfaceMatchesNativeShape
            """
            package sample0
            fun noop() {}
            """,
            // testCPointerUShortVarToKStringFromUtf16FunctionLinksToRuntimeSymbol
            """
            package sample1
            fun noop() {}
            """,
            // testCPointerUShortVarToKStringFromUtf16FunctionResolvesInSource
            """
            package sample2
