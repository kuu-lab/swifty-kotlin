...
final class JsStringInteropTests: XCTestCase {
    ...
    func testToJsStringIsRegistered() throws {
        ...
        XCTAssertEqual(sema.symbols.externalLinkName(for: function), "kk_string_toJsString_flat")
    ...
    func testToJsStringResolvesFromSource() throws {
        ...
        try withTemporaryFile(contents: source) { path in
            ...
            XCTAssertEqual(sema.symbols.externalLinkName(for: chosenCallee), "kk_string_toJsString_flat")
        }
    }
}
