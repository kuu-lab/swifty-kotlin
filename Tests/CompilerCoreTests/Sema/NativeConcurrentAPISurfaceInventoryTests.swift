...
struct NativeConcurrentAPISurfaceInventoryTests {
    ...
    private static let implementedTopLevelEntries: Set<TopLevelEntry> = [
        ...
        TopLevelEntry(name: "compareAndSwap", kind: .function, todo: nil),
        TopLevelEntry(name: "consumeFuture", kind: .function, todo: nil),
        TopLevelEntry(name: "current", kind: .property, todo: nil),
        TopLevelEntry(name: "decrement", kind: .function, todo: nil),
        ...
        TopLevelEntry(name: "fromCPointer", kind: .function, todo: nil),
        TopLevelEntry(name: "getAndAdd", kind: .function, todo: nil),
        TopLevelEntry(name: "getAndDecrement", kind: .function, todo: nil),
        TopLevelEntry(name: "getAndIncrement", kind: .function, todo: nil),
        TopLevelEntry(name: "hashCode", kind: .function, todo: nil),
        TopLevelEntry(name: "id", kind: .property, todo: nil),
        TopLevelEntry(name: "increment", kind: .function, todo: nil),
        ...
        TopLevelEntry(name: "start", kind: .function, todo: nil),
        TopLevelEntry(name: "toString", kind: .function, todo: nil),
        TopLevelEntry(name: "value", kind: .property, todo: nil),
