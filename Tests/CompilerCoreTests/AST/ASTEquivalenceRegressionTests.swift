...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    private let bundledStdlibDeclarationCount = 59
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 59 bundled stdlib functions (46 collections + 13 text)
        XCTAssertEqual(
            ast.declarationCount,
            2 + bundledStdlibDeclarationCount,
            "Expected 61 top-level declarations (2 user + 59 bundled stdlib)"
        )
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 59 bundled stdlib functions (46 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 2 + bundledStdlibDeclarationCount)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 59 bundled stdlib functions (46 collections + 13 text)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 59 bundled stdlib functions (46 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 59 bundled stdlib functions (46 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
