...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    private lazy var bundledStdlibDeclarationCount: Int = {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 60 bundled stdlib functions (37 collections + 6 seq-HOF + 17 text)
        XCTAssertEqual(
            ast.declarationCount,
            2 + bundledStdlibDeclarationCount,
            "Expected 62 top-level declarations (2 user + 60 bundled stdlib)"
        )
