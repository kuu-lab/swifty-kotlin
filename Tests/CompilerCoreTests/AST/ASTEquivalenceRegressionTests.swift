...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 30, "Expected 30 top-level declarations (2 user + 28 bundled stdlib)")
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 30)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 30)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 31)
        XCTAssertGreaterThanOrEqual(ast.arena.exprs.count, 6)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 31)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 28 bundled stdlib functions (17 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 31)
