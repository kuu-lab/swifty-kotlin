...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 28, "Expected 28 top-level declarations (2 user + 26 bundled stdlib)")
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 28)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 28)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 29)
        XCTAssertGreaterThanOrEqual(ast.arena.exprs.count, 6)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 29)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 26 bundled stdlib functions (8 Set HOFs + 7 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 29)
