...
final class ASTEquivalenceRegressionTests: XCTestCase {
    private let bundledStdlibTopLevelDeclarationCount = 40
    ...
    private func assertDeclarationCount(
        _ ast: ASTModule,
        userDeclarationCount: Int,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        XCTAssertEqual(
            ast.declarationCount,
            userDeclarationCount + bundledStdlibTopLevelDeclarationCount,
            file: file,
            line: line
        )
    }
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        assertDeclarationCount(ast, userDeclarationCount: 2)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        assertDeclarationCount(ast, userDeclarationCount: 3)
        XCTAssertGreaterThanOrEqual(ast.arena.exprs.count, 6)
