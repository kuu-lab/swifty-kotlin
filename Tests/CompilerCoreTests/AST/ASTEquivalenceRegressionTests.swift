...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 35, "Expected 35 top-level declarations (2 user + 33 bundled stdlib)")
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 35)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 35)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 36)
        XCTAssertGreaterThanOrEqual(ast.arena.exprs.count, 6)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 36)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 33 bundled stdlib functions (7 aggregate + 15 search + 11 text)
        XCTAssertEqual(ast.declarationCount, 36)
