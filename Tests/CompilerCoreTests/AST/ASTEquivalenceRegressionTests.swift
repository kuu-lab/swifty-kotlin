...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 23 bundled stdlib functions (7 collections + 16 text)
        XCTAssertEqual(ast.declarationCount, 25, "Expected 25 top-level declarations (2 user + 23 bundled stdlib)")
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 23 bundled stdlib functions (7 collections + 16 text)
        XCTAssertEqual(ast.declarationCount, 25)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 23 bundled stdlib functions (7 collections + 16 text)
        XCTAssertEqual(ast.declarationCount, 25)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 23 bundled stdlib functions (7 collections + 16 text)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 23 bundled stdlib functions (7 collections + 16 text)
        XCTAssertEqual(ast.declarationCount, 26)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 23 bundled stdlib functions (7 collections + 16 text)
        XCTAssertEqual(ast.declarationCount, 26)
