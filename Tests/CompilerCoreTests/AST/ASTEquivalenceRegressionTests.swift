...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    private let bundledStdlibDeclarationCount = 69
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 70 bundled stdlib functions (37 collections + 17 text + 16 random)
        XCTAssertEqual(
            ast.declarationCount,
            2 + bundledStdlibDeclarationCount,
            "Expected 72 top-level declarations (2 user + 70 bundled stdlib)"
        )
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 70 bundled stdlib functions
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 70 bundled stdlib functions
        XCTAssertEqual(ast.declarationCount, 2 + bundledStdlibDeclarationCount)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 70 bundled stdlib functions
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 70 bundled stdlib functions
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 70 bundled stdlib functions
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
