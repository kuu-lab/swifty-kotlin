...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    private let bundledStdlibDeclarationCount = 25
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 25 bundled stdlib functions (12 collections + 13 text)
        XCTAssertEqual(
            ast.declarationCount,
            2 + bundledStdlibDeclarationCount,
            "Expected 27 top-level declarations (2 user + 25 bundled stdlib)"
        )
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 25 bundled stdlib functions (12 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 2 + bundledStdlibDeclarationCount)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 25 bundled stdlib functions (12 collections + 13 text)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 25 bundled stdlib functions (12 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 25 bundled stdlib functions (12 collections + 13 text)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
