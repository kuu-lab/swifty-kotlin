...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    private let bundledStdlibDeclarationCount = 64
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 64 bundled stdlib functions (37 collections + 17 text + 10 time)
        XCTAssertEqual(
            ast.declarationCount,
            2 + bundledStdlibDeclarationCount,
            "Expected 66 top-level declarations (2 user + 64 bundled stdlib)"
        )
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 64 bundled stdlib functions (37 collections + 17 text + 10 time)
        XCTAssertEqual(ast.declarationCount, 2 + bundledStdlibDeclarationCount)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 64 bundled stdlib functions (37 collections + 17 text + 10 time)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 64 bundled stdlib functions (37 collections + 17 text + 10 time)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 64 bundled stdlib functions (37 collections + 17 text + 10 time)
        XCTAssertEqual(ast.declarationCount, 3 + bundledStdlibDeclarationCount)
