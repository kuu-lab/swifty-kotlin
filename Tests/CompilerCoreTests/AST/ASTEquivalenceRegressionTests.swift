...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 26 bundled stdlib functions (15 collections + 11 text)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 26 bundled stdlib functions (15 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 28)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 26 bundled stdlib functions (15 collections + 11 text)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 26 bundled stdlib functions (15 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 29)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 26 bundled stdlib functions (15 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 29)
