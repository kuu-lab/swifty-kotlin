...
final class ASTEquivalenceRegressionTests: XCTestCase {
    ...
    func testSimpleFunctionDeclAndExprCounts() throws {
        ...
        // 2 user declarations + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 37, "Expected 37 top-level declarations (2 user + 35 bundled stdlib)")
    ...
    func testBlockBodyDeclExprCounts() throws {
        ...
        // 2 user declarations + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 37)
    ...
    func testClassDeclAndExprCounts() throws {
        ...
        // classDecl + funDecl(main) + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 37)
    ...
    func testLambdaAndWhenExprCounts() throws {
        ...
        // 3 user declarations + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 38)
        XCTAssertGreaterThanOrEqual(ast.arena.exprs.count, 6)
    ...
    func testInterfaceDeclCounts() throws {
        ...
        // interface + class + fun(main) + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 38)
    ...
    func testAllSourceRangesValidForComplexInput() throws {
        ...
        // class + factorial + main + 35 bundled stdlib functions (24 collections + 11 text)
        XCTAssertEqual(ast.declarationCount, 38)
