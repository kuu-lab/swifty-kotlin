...
final class ABIMismatchTests: XCTestCase {
    ...
    func testMathFunctionCount() {
        ...
        // Random ABI includes default, seeded, bounded numeric helpers, range overloads, unsigned helpers, byte array helpers, SecureRandom helpers, and explicit bit extraction.
