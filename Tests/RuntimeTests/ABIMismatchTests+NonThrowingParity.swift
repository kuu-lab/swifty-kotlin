...
extension ABIMismatchTests {
    ...
    private static let legacyNonThrowingCalleeNames: Set<String> = [
        ...
        "__kk_bignum_toString",
        "__kk_string_toBigDecimal_flat",
        "__kk_string_toBigDecimalOrNull_flat",
        "__kk_string_toBigIntegerOrNull",
        "__kk_string_toBigIntegerOrNull_flat",
        "kk_string_toBoolean",
        ...
        "kk_weak_ref_create",
        "kk_weak_ref_get",
        // Per-type explicit constructor entry points added for catch-clause
        // sibling-type discrimination (kk_op_is nominal fallback fix).
        "kk_exception_new",
        "kk_runtime_exception_new",
        "kk_runtime_exception_new_message",
        "kk_runtime_exception_new_message_cause",
        "kk_error_new",
        "kk_error_new_message",
        "kk_error_new_message_cause",
        "kk_assertion_error_new",
        "kk_assertion_error_new_message",
        "kk_assertion_error_new_message_cause",
        "kk_illegal_state_exception_new",
        "kk_illegal_state_exception_new_message",
        "kk_illegal_state_exception_new_message_cause",
        "kk_illegal_argument_exception_new",
        "kk_illegal_argument_exception_new_message",
        "kk_illegal_argument_exception_new_message_cause",
        "kk_index_out_of_bounds_exception_new",
        "kk_index_out_of_bounds_exception_new_message",
        "kk_index_out_of_bounds_exception_new_message_cause",
        "kk_unsupported_operation_exception_new",
        "kk_unsupported_operation_exception_new_message",
        "kk_unsupported_operation_exception_new_message_cause",
        "kk_no_such_element_exception_new",
        "kk_no_such_element_exception_new_message",
        "kk_no_such_element_exception_new_message_cause",
        "kk_arithmetic_exception_new",
        "kk_arithmetic_exception_new_message",
        "kk_arithmetic_exception_new_message_cause",
        "kk_class_cast_exception_new",
        "kk_class_cast_exception_new_message",
        "kk_class_cast_exception_new_message_cause",
        "kk_number_format_exception_new",
        "kk_number_format_exception_new_message",
        "kk_number_format_exception_new_message_cause",
        "kk_uninitialized_property_access_exception_new",
        "kk_uninitialized_property_access_exception_new_message",
        "kk_uninitialized_property_access_exception_new_message_cause",
        "kk_null_pointer_exception_new",
    ]
