...
extension ABIMismatchTests {
    ...
    func testSyntheticStubExternalLinkNamesExistInABISpec() {
        ...
        let syntheticLinkNames: [String] = [
            ...
            "kk_atomic_int_array_createFromArray",
            "kk_atomic_int_array_size",
            "kk_atomic_int_array_toString",
            "kk_atomic_int_array_get",
            "kk_atomic_int_array_set",
            "kk_atomic_int_array_exchange",
            "kk_atomic_int_array_compareAndSet",
            "kk_atomic_int_array_compareAndExchange",
            "kk_atomic_int_array_getAndAdd",
            "kk_atomic_int_array_addAndGet",
            "kk_atomic_int_array_getAndIncrement",
            "kk_atomic_int_array_incrementAndGet",
            "kk_atomic_int_array_getAndDecrement",
            "kk_atomic_int_array_decrementAndGet",
            "kk_atomic_int_array_getAndUpdate",
            "kk_atomic_int_array_updateAndGet",
            "kk_atomic_long_array_create",
            "kk_atomic_long_array_createFromArray",
            "kk_atomic_long_array_size",
            "kk_atomic_long_array_toString",
            "kk_atomic_long_array_get",
            "kk_atomic_long_array_set",
            "kk_atomic_long_array_exchange",
            ...
            "kk_atomic_long_array_getAndUpdate",
            "kk_atomic_long_array_updateAndGet",
