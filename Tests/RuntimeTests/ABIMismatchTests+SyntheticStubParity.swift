...
extension ABIMismatchTests {
    ...
    func testSyntheticStubExternalLinkNamesExistInABISpec() {
        ...
        let syntheticLinkNames: [String] = [
            ...
            "kk_atomic_int_load",
            "kk_atomic_int_load_order",
            "kk_atomic_int_store",
            "kk_atomic_int_store_order",
            "kk_atomic_int_exchange",
            "kk_atomic_int_exchange_order",
            "kk_atomic_int_compareAndSet",
            "kk_atomic_int_compareAndSet_order",
            ...
            "kk_atomic_long_load",
            "kk_atomic_long_load_order",
            "kk_atomic_long_store",
            "kk_atomic_long_store_order",
            "kk_atomic_long_exchange",
            "kk_atomic_long_exchange_order",
            "kk_atomic_long_compareAndSet",
            "kk_atomic_long_compareAndSet_order",
            ...
            "kk_atomic_ref_load",
            "kk_atomic_ref_load_order",
            "kk_atomic_ref_store",
            "kk_atomic_ref_store_order",
            "kk_atomic_ref_exchange",
            "kk_atomic_ref_exchange_order",
            "kk_atomic_ref_compareAndSet",
            "kk_atomic_ref_compareAndSet_order",
            ...
            "kk_atomic_bool_load",
            "kk_atomic_bool_load_order",
            "kk_atomic_bool_store",
            "kk_atomic_bool_store_order",
            "kk_atomic_bool_exchange",
            "kk_atomic_bool_exchange_order",
            "kk_atomic_bool_compareAndSet",
            "kk_atomic_bool_compareAndSet_order",
