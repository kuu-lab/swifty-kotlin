...
extension ABIMismatchTests {
    ...
    private var allowedSpecOnlyRuntimeABINames: Set<String> {
        [
            ...
            "kk_java_duration_nano",
            "kk_java_duration_of_millis",
            "kk_java_duration_of_seconds",
            "kk_java_duration_seconds",
            "kk_java_duration_to_millis",
            "kk_java_duration_to_string",
            ...
            "kk_rolling_appender_new",
            "kk_slf4j_is_debug_enabled",
            "kk_slf4j_is_error_enabled",
            "kk_slf4j_is_info_enabled",
            "kk_slf4j_is_trace_enabled",
            "kk_slf4j_is_warn_enabled",
            "kk_slf4j_log_debug",
            "kk_slf4j_log_debug_1",
            "kk_slf4j_log_error",
            "kk_slf4j_log_error_1",
            "kk_slf4j_log_error_2",
            "kk_slf4j_log_info",
            "kk_slf4j_log_info_1",
            "kk_slf4j_log_info_2",
            "kk_slf4j_log_trace",
            "kk_slf4j_log_trace_1",
            "kk_slf4j_log_warn",
            "kk_slf4j_log_warn_1",
            "kk_slf4j_log_warn_2",
            "kk_slf4j_logger_get",
            "kk_slf4j_set_level",
            "kk_structured_appender_new",
            "kk_result_flatMap",
