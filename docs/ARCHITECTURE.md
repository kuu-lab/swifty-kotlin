...
| `KIR/` | 型付き中間表現 | `KIRModels.swift`, `BuildKIRPass.swift`, `KIRLoweringDriver.swift`, `KIRLoweringContext.swift`, `ExprLowerer.swift`, `CallLowerer.swift`, `CallSupportLowerer.swift`, `ControlFlowLowerer.swift`, `MemberLowerer.swift`, `LambdaLowerer.swift`, `ObjectLiteralLowerer.swift`, `ConstantCollector.swift`, `LateinitReadWrapping.swift`, `KClassAnnotationRegistrationLowering.swift`, `MutableCaptureCellHelpers.swift`, `RuntimeTypeCheckToken.swift` | IR 命令追加、コール生成修正 |
