...
- `CallLowerer+Base64MemberCalls.swift`: `kk_base64_\(operation)_\(suffix)`、`kk_base64_withPadding_\(suffix)`
- `HeaderHelpers+SyntheticBase64Stubs.swift`: `externalLinkName: "kk_base64_encode_\(suffix)"` など
