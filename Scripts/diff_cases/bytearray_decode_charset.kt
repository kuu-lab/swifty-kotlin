fun main() {
    ...
    println(String(utf8Bytes, Charsets.UTF_8)) // Hello
    ...
    println(String(latin1Bytes, Charsets.ISO_8859_1)) // Hello followed by e-acute

    // US-ASCII decoding
    val asciiBytes = byteArrayOf(65, 66, 67)
    println(String(asciiBytes, Charsets.US_ASCII)) // ABC

    // Empty array
    val empty = byteArrayOf()
    println(String(empty, Charsets.UTF_8)) // (empty)

    // Round-trip with UTF-8
    val original = "Hello, World!"
    val encoded = original.encodeToByteArray()
    println(String(encoded, Charsets.UTF_8)) // Hello, World!
}
