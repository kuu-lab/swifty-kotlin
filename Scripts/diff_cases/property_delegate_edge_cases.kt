...
// println side effect nor vetoable's accept/reject logic ever runs. (2) BUG-164: a bare-name
...
// Re-run with --force-run-skipped once BUG-151/BUG-164 land to confirm full parity.
